 ...
 */
  ...
  /*
   * The first thing in `Content`, and the reason that group was declared.
   *
   * It is not `Platform` because it is a different job done on a different
   * day: `Platform` is running the business — who is on it, what they pay —
   * and this is the shop window everybody who is NOT on it looks at.
   */
  {
    id: 'platform-website',
    label: 'Website',
    description: 'The cover images on afterbi.com, and the pictures on the product and about pages.',
    icon: Image,
    to: 'website',
    roles: ['owner'],
    group: 'Content',
   ...
   */
  {
    id: 'reminders',
    label: 'Reminders',
    description: 'What is overdue, waiting or running out, read back from your own records.',
    icon: BellRing,
    to: 'reminders',
    roles: EVERYONE,
    group: 'Daily',
