...
export const ACTIONS: AppAction[] = [
  ...
  {
    /*
     * First of the owner's tiles after Organisations, because it is the only
     * one with a queue behind it. Everything else on this console is a thing to
     * change when you feel like it; this is a list of people waiting for a
     * call.
     */
    id: 'platform-enquiries',
    label: 'Enquiries',
    description: 'Businesses that asked about AfterBI. Filed even when the email fails.',
    icon: Inbox,
    to: 'enquiries',
    roles: ['owner'],
    group: 'Platform',
  ...
  },
  {
    id: 'platform-website',
    label: 'Website',
    description: 'The walkthrough video and the photographs on afterbi.app.',
    icon: Globe,
    to: 'website',
    roles: ['owner'],
    group: 'Content',
  ...
  },
  {
    id: 'invite',
    label: 'Invite',
    description: 'Create an account, or send a distributor the code that makes them one.',
    icon: UserPlus,
    to: 'invite',
    roles: ADMINS,
    group: 'Company',
...
export const BAR: Record<Role, BarSlot[]> = {
  owner: [
    ...
    { id: 'platform-enquiries', label: 'Enquiries' },
    { id: 'menu', label: 'Menu' },
