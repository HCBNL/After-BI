...
export function DeskHero({
  ...
  return (
    <section className={cn('ab-hero ab-desk relative isolate overflow-hidden pb-[4.75rem]', className)}>
      <Bars className="pointer-events-none absolute -right-20 -top-16 -z-10 h-[28rem] w-[28rem] text-white/[0.045]" />
      <Bars className="pointer-events-none absolute -bottom-24 left-[42%] -z-10 h-64 w-64 text-white/[0.03]" />
...
export function MonthCard({ footnote }: { footnote?: string }) {
  ...
  return (
    ...
    >
      <Bars className="pointer-events-none absolute -right-6 -top-8 -z-10 h-36 w-36 text-brand-600/[0.07] dark:text-brand-400/[0.09]" />
