...
import { Bars } from '@/components/home/HomeArt';
    ...
    >
      ...
      >
        <div className="ab-hero relative isolate shrink-0 overflow-hidden px-4 pb-11 pt-2 text-white">
          <Bars className="pointer-events-none absolute -right-12 -top-10 -z-10 h-56 w-56 text-white/[0.05]" />
        ...
        <div className="shrink-0 border-t border-hairline px-4 py-3 pb-safe-4">
          <ThemeToggle full />
        </div>
      </div>
    </div>
